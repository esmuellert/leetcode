...
public class LRU {
    private final HashMap<Integer, LinkedList> hashmap;
    private final int capacity;
    private final LinkedList firstSentinel;
    private final LinkedList lastSentinel;
    private int size;

    public LRU(int capacity) {
        firstSentinel = new LinkedList(-1, -1, null,
                new LinkedList(-1, -1, null, null));
